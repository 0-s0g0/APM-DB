...
#include"edgeDetectFiltering.h"/*エッジ検出フィルタリング用ライブラリのインクルード*/
...
int main(int argc, char* argv[])
{
	...
	// readMasterが失敗した場合のエラーチェックをより具体的に行う
	if (master == NULL) {
