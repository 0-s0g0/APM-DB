...
#define TheNumberOfClass 10 //方向ヒストグラムの階調数
#define DivisionNumber 10 //錠剤の中心から輪郭までを同心円状に分割する個数
#define BinarizationNum 45 //濃淡画像を2値化するためのしきい値
#define deleteSmallAreaNum 500 //小領域を削除する時のしきい値
#define areaOfEdge 0.4//エッジの面積の割合
#define PI 3.14159265359 //円周率
#define WEIGHT 70 //錠剤の中心からの有効範囲(70=70%)
#define STRENGTHMAX 370  //方向ヒストグラムを作成する際の強度の最大値
...
typedef struct inputTablet{
	...
	double directionHist[TheNumberOfClass]; //方向ヒストグラム(0~1範囲)
	int threshold; //勾配ヒストグラムの強度のしきい値
